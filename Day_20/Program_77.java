import java.util.*;
class Program_77      // Program to multiply matrices.
{ 
    public static void main ( String args [] )
    {
        int i , j , k , sum , row_1 , row_2 , column_1 , column_2 ;
        ...
        if ( row_2 != column_1 )
        {
            System.out.println("Multipication of given two matrices is not possible.");
        }
        else
        {
